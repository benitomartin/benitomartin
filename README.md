...
| [Secure Streamlit App Deployment with AWS Cognito, Streamlit, and CircleCI](https://github.com/benitomartin/aws-cognito-circleci) | AWS Cognito<br>Google OAuth2 Client<br>CircleCI | AWS/GCP | Streamlit | Linting<br>Formatting<br>Testing<br>Pre-Commit<br>Error Handling<br>CI/CD |
...
| [Multi-Agent AI System with Docker, LangGraph and CircleCI](https://github.com/benitomartin/multiagent-langgraph-circleci) | OpenAI<br>AWS Bedrock<br>LangChain<br>LangGraph<br>AWS Lambda<br>Amazon ECR<br>Docker<br>CircleCI | AWS |  | Containerization<br>Linting<br>Formatting<br>Testing<br>Error Handling<br>CI/CD |
| [Serverless API with AWS SAM, Lambda, Gateway and Docker](https://github.com/benitomartin/sam-lambda-aws-api) | AWS SAM<br>AWS Lambda<br>AWS API Gateway<br>Docker | AWS |  | Containerization<br>Error Handling |

...
| --- | --- | :---: | :---: | --- |
| **ML/MLOps** |
| [MLOps Crypto Predictor](https://github.com/benitomartin/mlops-llm-crypto-predictor) | Quix Streams<br>MLflow<br>Scikit-learn<br>Optuna<br>Great Expectations<br>Pydantic| Civo |  | Experiment Tracking<br>Model Registry<br>Model/Data Monitoring<br>Data Validation<br>Linting<br>Formatting<br>Error Handling<br>Pre-Commit |

...
- 💰 My last personal **Data Science/Engineering/Analysis and ML** projects can be found in these repositories:
   ...
   - **Data Analysis + Modeling**:
      ...
      -  [News Classification](https://github.com/benitomartin/nlp-news-classification): EDA, Modeling and Deployment project: comparison of sevral Neural Networks (CNN, RNN, feedforward) and Multinomial Naive Bayes models and deployment in Streamlit (see [app](https://nlp-news-classification.streamlit.app/))

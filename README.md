...
- 💰 My last personal **Data Science/Engineering/Analysis and ML** projects can be found in these repositories:
   ...
   - **Machine Learning**:
      ...
      -  [RAG Harry Potter](https://github.com/benitomartin/rag_llama_deeplake): RAG (Retrieval-Augmented Generation) project for QA retrieval using Llama Index and Deep lake
   - **Data Engineering**:   

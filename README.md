...
| --- | --- | :---: | :---: | --- |
| **ML/MLOps** |
| [MLOps Crypto Predictor](https://github.com/benitomartin/mlops-llm-crypto-predictor) | Quix Streams<br>MLflow<br>Scikit-learn<br>Optuna<br>Great Expectations<br>Pydantic<br>Kubernetes<br>Kind<br>Kafka<br>Grafana<br>Risingwave<br>Minio<br>PostgreSQL| Civo |  | Experiment Tracking<br>Model Registry<br>Model/Data Monitoring<br>Data Validation<br>Linting<br>Formatting<br>Error Handling<br>Pre-Commit |
| [AWS Step Functions with CircleCI](https://github.com/benitomartin/aws-step-functions-circleci) | AWS Lambda<br>AWS Step Functions<br>CircleCI| AWS |  | Testing<br>Linting<br>Formatting<br>Error Handling<br>Pre-Commit<br>CI/CD |
...
| [Medical Insurance Costs Prediction](https://github.com/benitomartin/mlops-aws-insurance) | Scikit-learn<br>TensorFlow<br>Amazon SageMaker<br>AWS Lambda<br>Comet ML<br>Flask | AWS |  | Experiment Tracking<br>Model Registry<br>Model/Data Monitoring<br>Model/Data Monitoring<br>Linting<br>Formatting<br>Testing<br>Error Handling<br>Coverage<br>CI/CD |
| [Stroke Prediction](https://github.com/benitomartin/mlops-aws-stroke) | Scikit-learn<br>XGBoost<br>Amazon SageMaker<br>AWS Lambda<br>Amazon ECR<br>Comet ML<br>Flask<br>Docker | AWS |  | Experiment Tracking<br>Model Registry<br>Model Monitoring<br>Containerization<br>Testing<br>Error Handling |
...
| [Secure App Deployment with AWS Cognito, Streamlit, and CircleCI](https://github.com/benitomartin/aws-cognito-circleci) | AWS Cognito<br>Google OAuth2 Client<br>CircleCI | AWS/GCP | Streamlit | Linting<br>Formatting<br>Testing<br>Pre-Commit<br>Error Handling<br>CI/CD |
...
| [Music Clustering](https://github.com/benitomartin/mlops-music-clustering) | Scikit-learn<br>FastAPI<br>Amazon ECR<br>Docker | AWS | Streamlit | Containerization<br>CI/CD |
...
| [Automate Vector Database Update with AWS, Zilliz and CircleCI](https://github.com/benitomartin/embeddings-aws-circleci) | OpenAI<br>LangChain<br>Zilliz<br>AWS Lambda<br>Amazon ECR<br>Docker<br>CircleCI | AWS |  | Containerization<br>Linting<br>Formatting<br>Testing<br>Pre-Commit<br>Error Handling<br>CI/CD |
| [Multi-Agent AI System with Docker, LangGraph and CircleCI](https://github.com/benitomartin/multiagent-langgraph-circleci) | OpenAI<br>AWS Bedrock<br>LangChain<br>LangGraph<br>AWS Lambda<br>Amazon ECR<br>Docker<br>CircleCI<br>Pydantic | AWS |  | Containerization<br>Linting<br>Formatting<br>Testing<br>Error Handling<br>CI/CD |
| [Serverless GenAI API with FastAPI, AWS, and CircleCI](https://github.com/benitomartin/genai-aws-circleci) | OpenAI<br>AWS SAM<br>AWS Lambda<br>AWS API Gateway<br>AWS Secrets Manager<br>FastAPI<br>CircleCI<br>Pydantic | AWS |  | Linting<br>Formatting<br>Testing<br>Error Handling<br>CI/CD |
...
| [Scalable RAG in AWS with Fargate](https://github.com/benitomartin/aws-cdk-rag-fargate) | OpenAI<br>LlamaIndex<br>Qdrant<br>AWS CDK<br>AWS Fargate<br>Amazon ECR<br>Amazon ECS<br>AWS Secrets Manager<br>FastAPI | AWS |  | Testing<br>Error Handling |
...
| [Research Papers Semantic Search](https://github.com/benitomartin/rag-aws-qdrant) | OpenAI<br>LangChain<br>Qdrant<br>Docker<br>Amazon ECR<br>AWS Lambda<br>AWS API Gateway | AWS | Streamlit | Containerization<br>Linting<br>Formatting<br>Testing<br>Error Handling |

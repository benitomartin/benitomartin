...
🎵 While you're here, why not enhance your visit with a melodious twist? Tune into this enchanting [Spanish AI Song](https://youtu.be/M_Q_8-f0sAg?si=3rHyFr2sYSwIph6g). A perfect blend of technology and art. Enjoy the vibes! 🎷🎶


🌟 Crafting each piece of content is a journey that demands both time and passion. If you enjoy my work, consider supporting me on [GitHub Sponsors](https://github.com/sponsors/benitomartin) 🚀
...
<div align="center">
<img src="https://github.com/user-attachments/assets/20bba153-87af-450c-bd07-1aecbf44da2a" width="auto" height="130"/>
...
| --- | --- | :---: | :---: | --- |
| **ML/MLOps** |
| [Real-Time Crypto Forecasting Prediction Pipeline](https://github.com/benitomartin/mlops-llm-crypto-predictor) | Quix Streams<br>MLflow<br>Scikit-learn<br>Optuna<br>Great Expectations<br>Pydantic<br>Kubernetes<br>Kind<br>Kafka<br>Grafana<br>Risingwave<br>Minio<br>PostgreSQL| Civo |  | Experiment Tracking<br>Model Registry<br>Model/Data Monitoring<br>Data Validation<br>Linting<br>Formatting<br>Error Handling<br>Pre-Commit |
| [Event-Driven ETL with AWS Step Functions](https://github.com/benitomartin/aws-step-functions-circleci) | AWS Lambda<br>AWS Step Functions<br>CircleCI| AWS |  | Testing<br>Linting<br>Formatting<br>Error Handling<br>Pre-Commit<br>CI/CD |
| [Financial Risk Assessment System](https://github.com/benitomartin/mlops-databricks-credit-default) | Scikit-learn<br>LightGBM<br>MLflow<br>Databricks<br>Pydantic | AWS/Databricks |  | Experiment Tracking<br>Model Registry<br>Model/Data Monitoring<br>Data Validation<br>Linting<br>Formatting<br>Testing<br>Error Handling<br>Pre-Commit<br>IaC<br>CI/CD |
| [Healthcare Cost Forecasting System](https://github.com/benitomartin/mlops-aws-insurance) | Scikit-learn<br>TensorFlow<br>Amazon SageMaker<br>AWS Lambda<br>Comet ML<br>Flask | AWS |  | Experiment Tracking<br>Model Registry<br>Model/Data Monitoring<br>Model/Data Monitoring<br>Linting<br>Formatting<br>Testing<br>Error Handling<br>Coverage<br>CI/CD |
| [Medical Risk Prediction](https://github.com/benitomartin/mlops-aws-stroke) | Scikit-learn<br>XGBoost<br>Amazon SageMaker<br>AWS Lambda<br>Amazon ECR<br>Comet ML<br>Flask<br>Docker | AWS |  | Experiment Tracking<br>Model Registry<br>Model Monitoring<br>Containerization<br>Testing<br>Error Handling |
| [Ensemble Regression for Car Price Forecasting](https://github.com/benitomartin/mlops-car-prices) | Scikit-learn<br>TensorFlow<br>MLFlow<br>Prefect<br>Flask<br>Amazon ECR<br>AWS Lambda<br>Docker<br>Grafana<br>Terraform | AWS |  | Experiment Tracking<br>Model Registry<br>Model Monitoring<br>Orchestration<br>Containerization<br>Linting<br>Formatting<br>Testing<br>Error Handling<br>IaC<br>CI/CD |
| [Secure Social Authentication Integration with AWS Cognito](https://github.com/benitomartin/aws-cognito-circleci) | AWS Cognito<br>Google OAuth2 Client<br>CircleCI | AWS/GCP | Streamlit | Linting<br>Formatting<br>Testing<br>Pre-Commit<br>Error Handling<br>CI/CD |
| [Serverless API with AWS SAM](https://github.com/benitomartin/sam-lambda-aws-api) | AWS SAM<br>AWS Lambda<br>AWS API Gateway<br>Docker | AWS |  | Containerization<br>Error Handling<br>IaC |
| [Urban Transportation Cost Estimator](https://github.com/benitomartin/mlops-chicago-rides) | Scikit-learn<br>TensorFlow<br>MLFlow<br>Prefect<br>FastAPI<br>Docker | GCP |  | Experiment Tracking<br>Model Registry<br>Model Monitoring<br>Orchestration<br>Containerization<br>Error Handling |
| [Playlist Generator with K-Means & PCA](https://github.com/benitomartin/mlops-music-clustering) | Scikit-learn<br>FastAPI<br>Amazon ECR<br>Docker | AWS | Streamlit | Containerization<br>CI/CD |
...
| [Optimized RAG Retrieval with Indexing, Quantization, Hybrid Search and Caching](https://github.com/benitomartin/semantic-caching-qdrant-splade) | Qdrant<br>FastEmbed<br>SPLADE<br>Hugging Face Transformers |  |  | Error Handling<br>Linting<br>Formatting |
| [Multimodal Smart Document Processing System](https://github.com/benitomartin/aws-multimodal-bedrock-dynamodb) | AWS Bedrock<br>AWS Lambda<br>AWS DynamoDB<br>AWS SQS/SNS<br>AWS CDK<br>Claude 3 Sonnet | AWS |  | Error Handling<br>Linting<br>Formatting<br>IaC |
| [Terraform-Based Bedrock RAG Deployment](https://github.com/benitomartin/aws-bedrock-opensearch-langchain) | AWS Bedrock<br>LangChain<br>AWS Opensearch<br>AWS Secrets Manager<br>Terraform<br>Titan | AWS |  | Testing<br>Error Handling<br>Linting<br>Formatting<br>IaC |
| [Infrastructure-as-Code RAG Deployment on AWS](https://github.com/benitomartin/aws-cdk-rag-fargate) | OpenAI<br>LlamaIndex<br>Qdrant<br>AWS CDK<br>AWS Fargate<br>Amazon ECR<br>Amazon ECS<br>AWS Secrets Manager<br>FastAPI | AWS |  | Testing<br>Error Handling |
...
| [Kubernetes-Powered Semantic Code Search System](https://github.com/benitomartin/scale-gke-qdrant-llama) | OpenAI<br>LlamaIndex<br>Qdrant<br>Docker<br>FastAPI<br>GKE | GCP | Streamlit | Containerization<br>Linting<br>Formatting<br>Testing<br>Error Handling<br>CI/CD |
| [Academic Paper Q&A with Serverless RAG](https://github.com/benitomartin/rag-aws-qdrant) | OpenAI<br>LangChain<br>Qdrant<br>Docker<br>Amazon ECR<br>AWS Lambda<br>AWS API Gateway | AWS | Streamlit | Containerization<br>Linting<br>Formatting<br>Testing<br>Error Handling |
...
| [Hybrid Knowledge Agentic RAG System](https://github.com/benitomartin/agentic-RAG-langchain-pinecone) | OpenAI<br>Groq<br>LangChain<br>Pinecone |  |  |  |
| [Collaborative Multi-Agent RAG with CrewAI](https://github.com/benitomartin/crewai-rag-langchain-qdrant) | OpenAI<br>LangChain<br>Qdrant<br>CrewAI Agents |  |  |  |
...
| [Fake News Detection with NLP Architectures](https://github.com/benitomartin/nlp-news-classification) | Scikit-learn (Multinomial Naive Bayes)<br>Tensorflow (CNN, RNN, feedforward) |  | Streamlit |  |
| [Feature-Driven Cancer Classification](https://github.com/benitomartin/ibm-advanced-ds-capstone) | Scikit-learn<br>Spark | IBM |  |  |
...
| **Data Engineering** |
| [Hotel Reviews ETL Pipeline on GCP](https://github.com/benitomartin/de-hotel-reviews) | Prefect<br>Spark<br>SQL<br>BigQuery<br>dbt<br>Terraform<br>Looker | GCP |  | Orchestration<br>Linting<br>Formatting<br>Error Handling<br>Pre-Commit<br>IaC<br>CI/CD |
| [Swiss Air Quality Data Engineering Pipeline](https://github.com/benitomartin/de-ch-weather) | Mage<br>dbt<br>SQL<br>BigQuery<br>Docker<br>Terraform<br>Looker | GCP |  | Orchestration<br>IaC<br>Containerization<br>CI/CD |
| **Miscellaneous** |
...
| [Docker Container Optimization Benchmark](https://github.com/benitomartin/uv-docker-benchmark) | Docker<br>FastAPI<br>uv |  |  | Error Handling |
| [Automatic AWS S3 Buckets Deletion](https://github.com/benitomartin/delete-all-aws-s3-buckets) | AWS S3 | AWS |  | Error Handling |
